...
<body>
    ...
    <div class="container pt-5 my-5 border bg-success text-white">
        ...
        <form action="adminlogin.php" method='POST' enctype="multipart/form-data" class="row g-3">
...
if ($_SERVER['REQUEST_METHOD']=='POST') 

        {
            ...
            $query= "(SELECT * FROM `admin` WHERE phone='$ph' and pass='$pas')";
            ...
            if($login>=1  && $ph=='9079857902')
            {
              

              header("location:http://localhost/YT%20Shopping/admindata.php");
            ...
            else if($login>=1)
            {
              ...
              header("location:http://localhost/YT%20Shopping/index.php");
